...
bgRoad = pg.image.load("files/bgRoad.png")
sharkIm = pg.image.load("files/shark.png")
rocketIm = pg.image.load("files/rocket.png")
bombIm = pg.image.load("files/bomb.png")
...
class Cherry(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load("files/cherry.png")
...
class Coin(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load("files/coin.png")
        self.rect = self.image.get_rect()
        self.speed = 7
    def move(self):
        global money
...
class Enemy(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load("files/bomb.png")
        self.rect = self.image.get_rect()
...
class Shark(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load("files/shark.png")
        self.rect = self.image.get_rect()
...
pg.mixer.music.load("files/bgMusic.mp3")
pg.mixer.music.play()
